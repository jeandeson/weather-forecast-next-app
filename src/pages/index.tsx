    ...
    useEffect(() => {
        function getCurrentTheme(forecastData: Forecast[]) {
            if (forecastData[0].current?.weather[0].main === "Rain") {
                ...
                setState({
                    backgroundImg: "https://ak.picdn.net/shutterstock/videos/7320100/thumb/1.jpg",
                });
            } else {
                setState({
                    backgroundImg: "https://t4.ftcdn.net/jpg/03/36/32/85/360_F_336328559_Yj7LbFIlTC9Zj7qbkcJ4IJJ3yWimb4x0.jpg",
                });
            }
        }
...
export const getServerSideProps: GetServerSideProps = async () => {
    ...
    const forecastResponse: ForecastData = jsonResponse;
    return {
        props: {
